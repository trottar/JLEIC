int yields() {
  ...
  TString myFile1 = DataDir + "/TDIS-MC05x050_q23.75.root"; // 5 on 50, Q2=(3.5,4.0) GeV2
  TString myFile2 = DataDir + "/TDIS-MC05x050_q212.root"; // 5 on 50, Q2=(11.5,12.5) GeV2
  TString myFile3 = DataDir + "/TDIS-MC05x050_q230.root"; // 5 on 50, Q2=(28.8,31.2) GeV2
  TString myFile4 = DataDir + "/TDIS-MC05x050_q260.root"; // 5 on 50, Q2=(57.6,62.4) GeV2
  TString myFile5 = DataDir + "/TDIS-MC05x050_q2120.root"; // 5 on 50, Q2=(115,125) GeV2
  TString myFile6 = DataDir + "/TDIS-MC05x050_q2240.root"; // 5 on 50, Q2=(230,250) GeV2
  ...
  myXpiHist1->Draw();
  myXpiHist1->GetXaxis()->SetTitle("xpi");
  ...
  c1->Print("pion_distributions_5_on_50.pdf","pdf");
