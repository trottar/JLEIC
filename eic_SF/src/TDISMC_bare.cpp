 ...
 * ================================================================
 * Time-stamp: "2020-04-29 15:07:40 trottar"
 * ================================================================
 *
...
int mainx(double xMin,double xMax, double Q2Min,double Q2Max, double rnum, const int nevts, const double pbeam, const double kbeam){
  ...
  sprintf(tTitle,"Bare p(e,e'\u03C0n)X Event Generation %3.0f GeV/c x%4.0f GeV/c",kBeam, PBeam);
  sprintf(rName,"../OUTPUTS/bare_pi_n_%.0fon%.0f.root", kBeam, PBeam);

  TFile fRoot(rName,"Recreate", tTitle);
  sprintf(tName,"bare_pi_n");
  ...
  ofstream OUT (Form("../OUTPUTS/bare_pi_n_%.0fon%.0f_lund.dat", kBeam, PBeam), ios::trunc);
